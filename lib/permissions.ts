...
// Re-exported for server-side callers (real definition in lib/team-hierarchy.ts, which has no Prisma import so the client-side Settings UI can import it directly too).
